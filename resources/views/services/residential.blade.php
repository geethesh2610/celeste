<x-layout>
    ...
    <section data-no-glass-active class="relative h-[60vh] md:h-[40vh] lg:h-screen has-background overflow-hidden">
        <img data-speed="0.5" src="{{ secure_asset('assets/images/services/residential.jpeg') }}" class="hidden md:block w-full h-full object-cover object-bottom z-1" alt="">
        <img src="{{ secure_asset('assets/images/services/residential.jpeg') }}" class="md:hidden w-full h-full object-cover object-bottom z-1" alt="">
        ...
        <div class="py-[20.884vw] md:py-[8.681vw] 3xl:py-[8.247vw] px-[4.651vw] md:px-[2.315vw] 3xl:px-[2.199vw]">
            <div class="flex flex-col md:flex-row md:items-end gap-[7.767vw] md:gap-[7.407vw] 3xl:gap-[7.037vw]">
                ...
                <div class="md:w-[49.32%]">
                    <p class="font-satoshi font-medium text15px-mobile text-[#3E3E3E] text22px-desktop leading-[1.40] w-full md:w-[41.088vw] 3xl:w-[39.034vw]">Discover expansive residential land opportunities in Dubai’s most sought-after neighborhoods. Whether you’re looking to build a luxury villa, a family home, or a smart hold-for-future-gain, our curated portfolio of residential plots offers access to prime locations, strong infrastructure, and growth potential.</p>
    ...
    {{-- What to Consider Section Start --}}
            ...
            @php
                $landServices = [
                    [
                        ...
                        'content' => ['Access to transport, amenities, schools, retail and leisure adds value and lifestyle appeal.'],
                    ],

                    [
                        'title' => 'Zoning & regulations',
                        'content' => ['Ensure that the land’s permitted use aligns with your build plan and investment horizon.'],
                    ],

                    [
                        'title' => 'Future growth & appreciation',
                        'content' => ['We assess upcoming master-plans, infrastructure projects and market trends to select plots positioned for upside.'],
                    ],

                    [
                        'title' => 'Exit-strategy flexibility',
                        'content' => ['Whether you hold for 5-10 years or build immediately, our listings cater to diverse time-horizons.'],
                    ],
                ];
            @endphp
            ...
            <div class="flex flex-col md:flex-row justify-between items-end gap-[9.302vw] md:gap-[2.315vw] 3xl:gap-[2.199vw]">
                <div class="w-dull md:w-[57.813vw] 3xl:w-[54.922vw]">
                    <div class="relative">
                        <div data-animate class="flex items-center gap-[2.558vw] md:gap-[0.637vw] 3xl:gap-[0.605vw] mb-[4.651vw] md:mb-[2.894vw] 3xl:mb-[2.749vw] mt-[2.326vw] md:mt-[0.579vw] 3xl:mt-[0.550vw]">
                            <span class="rounded-full bg-[#00A7E1] size-[2.791vw] md:size-[0.694vw] 3xl:size-[0.660vw]"></span>
                            <p class="uppercase font-satoshi text-[#1D1D1D] font-bold text18px-desktop">Choose us</p>
                        </div>
                        <h2 data-animate-heading class="flex flex-col font-uncut font-medium text40px-mobile text72px-desktop leading-[1.08] -tracking-[0.326vw] md:-tracking-[0.081vw] 3xl:-tracking-[0.077vw]">
                            <span class="inline-block will-change-transform">Why Choose Us</span>
                        </h2>
                    </div>
                    @php
                        $partnerReasons = [
                            [
                                ...
                                'description' => 'Exclusive access to residential land parcels in top zones of Dubai — from affluent beachfront communities to emerging suburban master-planned districts.',
                            ],
                            [
                                'number' => '02',
                                'title' => 'Verified Expertise',
                                'description' => 'In-depth market knowledge and first-hand relationships ensure you receive transparent, verified land options suited for both owner-occupiers and investors.',
                            ],
                            [
                                'number' => '03',
                                'title' => 'Full Support',
                                'description' => 'End-to-end support: from site visits and zoning checks, through documentation and hand-over assistance, to post-purchase guidance.',
                            ],
                            [
                                'number' => '04',
                                'title' => 'Value Focused',
                                'description' => 'Our focus is on long-term value: we identify zones with infrastructure momentum, favourable regulation, and high residential demand.',
                            ],
                        ];
                    @endphp
                ...
                <div class="w-full md:w-[36.458vw] 3xl:w-[34.635vw]">
                    <img src="{{ secure_asset('assets/images/services/residential-down.png') }}" class="w-full h-auto object-cover" alt="">
                </div>
            </div>
        </div>
    </section>
