<x-layout>
    ...
    <section data-no-glass-active class="relative h-[60vh] md:h-[40vh] lg:h-screen has-background overflow-hidden">
        <img data-speed="0.5" src="{{ secure_asset('assets/images/services/industrial.jpeg') }}" class="hidden md:block w-full h-full object-cover object-bottom z-1" alt="">
        <img src="{{ secure_asset('assets/images/services/industrial.jpeg') }}" class="md:hidden w-full h-full object-cover object-bottom z-1" alt="">
        <div class="absolute inset-0 flex items-end pb-[12vw] p-[4.651vw] md:p-[3.472vw] 3xl:p-[3.299vw]">
            <div class="flex flex-col gap-[2.791vw] md:gap-[0.694vw] 3xl:gap-[0.660vw]">
                <div class="flex items-center gap-[1vw] font-satoshi font-medium text-[#EBEBEB] font-bold text15px-mobile text18px-desktop leading-[1.61]">
                    ...
                    <p>></p>
                    <p>Industrial and Logistic Advisory Services</p>
                </div>
                <h1 class="font-uncut font-medium text56px-mobile  text-white text160px-desktop leading-[.9375] mt-[4.163vw] md:mt-[2.778vw] 3xl:mt-[2.639vw]">Industrial and <br>Logistic Advisory Services</h1>
            </div>
        </div>
    </section>
        ...
        <div class="py-[20.884vw] md:py-[8.681vw] 3xl:py-[8.247vw] px-[4.651vw] md:px-[2.315vw] 3xl:px-[2.199vw]">
            <div class="flex flex-col md:flex-row md:items-end gap-[7.767vw] md:gap-[7.407vw] 3xl:gap-[7.037vw]">
                ...
                <div class="md:w-[49.32%]">
                    <p class="font-satoshi font-medium text15px-mobile text-[#3E3E3E] text22px-desktop leading-[1.40] w-full md:w-[41.088vw] 3xl:w-[39.034vw]">At Celeste, we offer a meticulously designed array of industrial and logistics real estate services to meet the evolving demands of supply chains, manufacturing, and distribution sectors. Our expertise combines strategic insight, financial acumen, and operational excellence to deliver tailored solutions for investors, developers, and occupiers.</p>
                    <div class="mt-[9.279vw] md:mt-[4.051vw] 3xl:mt-[3.848vw] w-max md:hidden">
                        <a href="{{ route('plots.index', 'industrial-projects') }}" class="bg-[#1D1D1D] border border-[#1D1D1D] rounded-[1.395vw] md:rounded-[0.347vw] 3xl:rounded-[0.330vw] flex items-center gap-[2.791vw] md:gap-[0.694vw] 3xl:gap-[0.660vw] px-[6.977vw] md:px-[1.736vw] 3xl:px-[1.649vw] py-[4.884vw] md:py-[1.215vw] 3xl:py-[1.155vw] group duration-300 transition-colors hover:bg-white">
                            <p class="font-satoshi font-medium text20px-desktop text-white duration-300 transition-colors group-hover:text-[#1D1D1D]">See Industiral Plots</p>
                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" class="text-[#00A7E1] h-auto w-[3.766vw] md:w-[0.937vw] 3xl:w-[0.890vw] duration-300 group-hover:rotate-45" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.6787 12.0643L13.466 12.0505L12.2238 11.9711L12.0366 11.9593V3.00585L1.44659 13.5959L0.283039 12.4323L10.8738 1.84161H2.10674L1.9196 1.8423L1.90717 1.65448L1.82845 0.412898L1.81464 0.200213L2.02802 0.199523H13.6787V12.0643Z" fill="currentColor" stroke="currentColor" stroke-width="0.4" />
                            </svg>
                        </a>
            ...
            @php
                $landServices = [
                    [
                        ...
                        'content' => ['Tenant & Landlord Representation: We assist occupiers and property owners in securing optimal lease terms for warehouse space, distribution hubs, or cold-storage facilities through market intelligence, negotiation, and structured agreements.', 'Built-to-Suit Solutions: We partner with developers and occupiers to deliver custom built-to-suit facilities from site selection and design to construction and handover, ensuring alignment with operational needs and timelines.'],
                    ],
                    [
                        'title' => 'Industrial Space',
                        'content' => ['Acquisition & Disposition Advisory: We guide clients through buying or selling industrial properties, supported by market research, feasibility assessments, and portfolio optimisation strategies.', 'Occupier Services: We source, evaluate, and negotiate industrial spaces for occupiers across manufacturing, distribution, fulfilment centres, and flex-space categories.'],
                    ],
                    [
                        'title' => 'Built-to-Suit Leasing',
                        'content' => ['Design & Execution: We manage turnkey built-to-suit industrial development—from design and construction to lease finalisation—ensuring cost, specification, and timeline goals are met.', 'Long-Term Planning: We integrate scalable layouts, automation-ready designs, and adaptable facility strategies to support long-term business growth.'],
                    ],
                    [
                        'title' => 'Financial Feasibility',
                        'content' => ['Feasibility Analysis & Market Studies: Our financial models analyse supply-chain trends and asset demand to assess project viability, including returns, cap rates, and investment thresholds.', 'Capital Planning & Funding Strategy: We support capital planning by connecting clients with lenders or equity partners and structuring debt-equity mixes aligned with project objectives.'],
                    ],
                    [
                        'title' => 'Development Advisory',
                        'content' => ['Project Planning & Management: We provide end-to-end development oversight—from due diligence and entitlements to contractor coordination and compliance oversight.', 'Strategic Site Selection: We use spatial analytics and logistics modelling to identify high-performance locations that optimise supply-chain cost and operational efficiency.'],
                    ],
                    [
                        'title' => 'Buy-Side Advisory',
                        'content' => ['Target Identification & Acquisition Support: We identify and evaluate acquisition opportunities, managing negotiations, due diligence, and execution to build high-quality industrial portfolios.', 'Portfolio Strategy & Optimization: We enhance portfolio performance through continuous asset and lease management, strategic repositioning, and regular performance reviews.'],
                    ],
                ];
        ...
        <div class="px-[4.651vw] md:px-[2.315vw] 3xl:px-[2.199vw] pt-[13.953vw] md:pt-[3.472vw] 3xl:pt-[3.299vw] pb-[20.907vw] md:pb-[6.944vw] 3xl:pb-[6.597vw]">
            <div class="flex flex-col md:flex-row justify-between items-end gap-[9.302vw] md:gap-[2.315vw] 3xl:gap-[2.199vw]">
                ...
                <div class="w-full md:w-[36.458vw] 3xl:w-[34.635vw]">
                    <img src="{{ secure_asset('assets/images/services/industrial-down.png') }}" class="w-full h-auto object-cover" alt="">
                </div>
            </div>
        </div>
    </section>
