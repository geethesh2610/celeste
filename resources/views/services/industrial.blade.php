<x-layout>
    ...
    <section data-no-glass-active class="relative h-[60vh] md:h-[40vh] lg:h-screen has-background overflow-hidden">
        <img data-speed="0.5" src="{{ secure_asset('assets/images/services/industrial.png') }}" class="hidden md:block w-full h-full object-cover object-bottom z-1" alt="">
        <img src="{{ secure_asset('assets/images/services/industrial.png') }}" class="md:hidden w-full h-full object-cover object-bottom z-1" alt="">
