            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-[6.977vw] md:gap-[4.861vw] 3xl:gap-[4.618vw]">
                ...
                <div class="relative">
                    ...
                    <div class="mt-0 md:mt-[2.315vw] 3xl:mt-[2.199vw]">
                        ...
                        @if (!empty($plot->features_tag) && count($plot->features_tag))
                            {{-- Key features --}}
                        ...
                        @if (!empty($plot->description))
                            ...
                            <div class="mt-[10.256vw] md:mt-[5.787vw] 3xl:mt-[5.498vw]">
                                ...
                                <div class="mt-[4.651vw] md:mt-[1.157vw] 3xl:mt-[1.100vw] md:w-[95%]">
                                    <div class="prose max-w-full
                                        prose-p:md:text-[1.273vw] prose-p:3xl:text-[1.209vw] prose-p:leading-[1.34] prose-p:text-[#595959] prose-p:-tracking-[0.060vw] prose-p:md:-tracking-[0.015vw] prose-p:3xl:-tracking-[0.014vw] prose-p:my-[1.395vw] md:prose-p:my-[0.347vw] 3xl:prose-p:my-[0.330vw]
                                        prose-ul:list-disc prose-ul:pl-[4.186vw] prose-ul:md:pl-[1.042vw] prose-ul:3xl:pl-[0.990vw]
                                        prose-li:mb-[1.395vw] prose-li:md:mb-[0.347vw] prose-li:3xl:mb-[0.330vw] prose-li:text-[#595959] prose-li:md:text-[1.273vw] prose-li:3xl:text-[1.209vw] prose-li:font-satoshi prose-li:leading-normal prose-li:-tracking-[0.060vw] prose-li:md:-tracking-[0.015vw] prose-li:3xl:-tracking-[0.014vw]
