<form action="">
    <div class="space-y-[11.163vw] md:space-y-[2.778vw] 3xl:space-y-[2.639vw]">
        {{-- Submitted from page --}}
        <input type="hidden" name="submitted_from_page" id="">
        {{-- Submitted from page url --}}
        <input type="hidden" name="submitted_from_url" id="">

        <!-- Name Input -->
        <div class="relative">
            <input type="text" placeholder="Name" class="w-full text20px-desktop text-[#3E3E3E] border-b-2 border-dashed border-[#737373] bg-transparent pb-[2.791vw] md:pb-[0.694vw] 3xl:pb-[0.660vw] outline-none focus:border-[#000000] focus:border-solid placeholder:text-[#3E3E3E] transition-colors">
        </div>
        ...
        <div class="relative">
            <div class="flex items-center gap-3 border-b-2 border-dashed border-[#737373] pb-[2.791vw] md:pb-[0.694vw] 3xl:pb-[0.660vw] focus-within:border-[#000000] focus-within:border-solid transition-colors">
                ...
                <input type="tel" class="flex-1 text20px-desktop text-[#3E3E3E] bg-transparent outline-none placeholder:text-[#3E3E3E]" placeholder="Phone number">
            </div>
        </div>

        <!-- Email Input -->
        <div class="relative">
            <input type="email" placeholder="Email address" class="w-full text20px-desktop text-[#3E3E3E] border-b-2 border-dashed border-[#737373] bg-transparent pb-[2.791vw] md:pb-[0.694vw] 3xl:pb-[0.660vw] outline-none focus:border-[#000000] focus:border-solid placeholder:text-[#3E3E3E] transition-colors">
        </div>

        <!-- Message Input -->
        <div class="relative">
            <input type="text" placeholder="Your message" class="w-full text20px-desktop text-[#3E3E3E] border-b-2 border-dashed border-[#737373] bg-transparent pb-[2.791vw] md:pb-[0.694vw] 3xl:pb-[0.660vw] outline-none focus:border-[#000000] focus:border-solid placeholder:text-[#3E3E3E] transition-colors">
        </div>

        <div class="mt-[12.791vw] md:mt-[5.671vw] 3xl:mt-[5.388vw]">
            <a href="#" class="w-max bg-[#1D1D1D] border border-[#1D1D1D] rounded-[1.395vw] md:rounded-[0.347vw] 3xl:rounded-[0.330vw] flex items-center gap-[2.791vw] md:gap-[0.694vw] 3xl:gap-[0.660vw] px-[6.977vw] md:px-[1.736vw] 3xl:px-[1.649vw] py-[4.884vw] md:py-[1.215vw] 3xl:py-[1.155vw] group duration-300 transition-colors hover:bg-[#F2EEE8]">
                <p class="font-satoshi font-medium text20px-desktop text-white duration-300 transition-colors group-hover:text-[#1D1D1D]">Submit Message</p>
